...
class JwstInfo(BaseModel):
    ...
    @classmethod
    def new(cls, *, filepath: FilePath | str, stage: str, force_with_wcs: bool = False) -> 'JwstInfo':
        """
    ...
    @validate_call   
    def update(self, *, filepath: FilePath, stage: str, force_with_wcs: bool = False) -> None:
        """
