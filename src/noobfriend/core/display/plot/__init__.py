...
- :func:`imshow_stack` — several frames overlaid at their own offsets with a
  segmented control (and optional auto-blink) to flip between them.
...
from noobfriend.core.display.plot._stack import imshow_stack

__all__ = ["imshow", "imshow_stack", "plot_footprints", "set_render_mode"]
